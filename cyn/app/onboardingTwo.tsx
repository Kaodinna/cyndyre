...
export default function onboardingTwoScreen() {
  ...
  const fashionShop = require("../assets/images/Sales consulting-pana 1.png");
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View className="p-4 flex justify-between flex-col flex-1">
        ...
        <View className="flex gap-[40px] items-center">
          <Image
            source={fashionShop}
            className="min-w-[350px] min-h-[233.33px]"
          />
          <View className="flex flex-col gap-[16px] items-center">
            ...
            >
              You can make payment for your order conveniently, secured and
              safe. Our payment process is swift and easy
            </Text>
          </View>
        </View>
        <View className="">
